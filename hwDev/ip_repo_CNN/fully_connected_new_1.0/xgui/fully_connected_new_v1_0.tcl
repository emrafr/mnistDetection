...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S09_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_S08_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "C_S10_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
