...
entity fully_connected_new_v1_0_S08_AXIS is
	generic (
...
end fully_connected_new_v1_0_S08_AXIS;

architecture arch_imp of fully_connected_new_v1_0_S08_AXIS is
...
begin
	...
	-- FIFO write enable generation
	 --fifo_wren <= axis_tready = '1' and (s_axis_tvalid ='1' or current_address >= 1351);
	 process(s_axis_tvalid, current_address, axis_tready)
	 begin
	 if(axis_tready = '1' and (s_axis_tvalid ='1' or current_address >= 1351)) then
	   fifo_wren <= '1';
	 else
	   fifo_wren <= '0';
	 end if;
