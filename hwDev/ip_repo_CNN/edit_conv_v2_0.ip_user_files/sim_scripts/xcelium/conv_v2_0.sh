...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.conv_v2_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.conv_v2_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/emma/dev/vivadoProjects/ip_repo_CNN/edit_conv_v2_0.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log conv_v2_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
