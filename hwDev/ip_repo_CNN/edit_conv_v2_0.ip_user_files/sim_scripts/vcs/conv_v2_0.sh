...
#
# Script generated by Vivado on Tue May 07 13:09:31 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conv_v2_0.sh
...
#
# Usage        : conv_v2_0.sh
#                conv_v2_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv_v2_0.sh [-reset_run]
#                conv_v2_0.sh [-reset_log]
#                conv_v2_0.sh [-help]
#
...
#                script (type 'conv_v2_0.sh -help' for more information).
#
...
# script info
echo -e "conv_v2_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv_v2_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv_v2_0 -o conv_v2_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conv_v2_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/emma/dev/vivadoProjects/ip_repo_CNN/edit_conv_v2_0.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key conv_v2_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv_v2_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conv_v2_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conv_v2_0.sh [-help]\n\
Usage: conv_v2_0.sh [-step]\n\
Usage: conv_v2_0.sh [-lib_map_path]\n\
Usage: conv_v2_0.sh [-reset_run]\n\
Usage: conv_v2_0.sh [-reset_log]\n\
Usage: conv_v2_0.sh [-keep_index]\n\
Usage: conv_v2_0.sh [-noclean_files]\n\n\
