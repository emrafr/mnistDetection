...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot conv_v2_0 xil_defaultlib.conv_v2_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conv_v2_0 -key {Behavioral:sim_1:Functional:conv_v2_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conv_v2_0.wdb xsim.dir libdpi.so)
